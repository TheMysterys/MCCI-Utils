...
public class Sounds {
    ...
    private static final Identifier QUEST_COMPLETE_SOUND_ID = new Identifier("mcc:l");
    ...
    public static SoundEvent QUEST_COMPLETE_SOUND = new SoundEvent(QUEST_COMPLETE_SOUND_ID);
